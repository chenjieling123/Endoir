...
if __name__ == '__main__':
    ...
    for test_data_name in test_data_names:
        ...
        PSNR.sort()
        SSIM.sort()
        print('Q1  {:.3f} '.format(MSE[161]))
        print('Q2  {:.3f} '.format(MSE[322]))
        print('Q3  {:.3f} '.format(MSE[483]))
        print('MSE  {mses.avg:.3f}'.format(mses=MSEs))
        print('Q1  {:.3f} '.format(PSNR[161]))
        print('Q2  {:.3f} '.format(PSNR[322]))
        print('Q3  {:.3f} '.format(PSNR[483]))
        print('PSNR  {psnrs.avg:.3f}'.format(psnrs=PSNRs))
        print('Q1  {:.3f} '.format(SSIM[161]))
        print('Q2  {:.3f} '.format(SSIM[322]))
        print('Q3  {:.3f} '.format(SSIM[483]))
        print('ssim  {ssims.avg:.3f}'.format(ssims=SSIMs))
